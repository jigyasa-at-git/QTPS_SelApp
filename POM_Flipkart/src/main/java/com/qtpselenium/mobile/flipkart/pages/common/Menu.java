...
public class Menu {
   ...
   public WebDriver driver;
	...
	public Object clickOnMenuItem(String text) throws InterruptedException{
		...
		int width=0;
		if(driver.findElements(By.id("com.flipkart.android:id/multiwidgetScrollView")).size() !=0)
		  width=driver.findElement(By.id("com.flipkart.android:id/multiwidgetScrollView")).getSize().width;
		...
		if(width ==1080  & s > 0){
			...
			return psPage;
		}if(driver.findElements(By.xpath("//android.widget.TextView[starts-with(@text,'FILTER')]")).size() >0){
