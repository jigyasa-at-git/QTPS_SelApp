...
public class MakeMyTripTest {
	...
	public void selectDate(String date) throws ParseException {
		...
		dri
		MyArrayList<WebElement> prices = driver.findElements(By.id("com.makemytrip:id/intl_fate_txt"));
		...
		//}
		while(true){
			driver.swipe(200, prices.get(prices.size()-1).getLocation().y, 200, prices.get(prices.size()-1).getLocation().y-264, 2000);
		}
